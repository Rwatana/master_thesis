...
\begin{enumerate}
    ...
    \item 説明可能性技術：Integrated Gradients (IG)
    \begin{itemize}
...
\begin{itemize}
    \item 研究の貢献: マルチモーダルな深層学習モデルを用いることで高い予測精度を実現しつつ、XAI技術（Integrated Gradients）を導入することで、これまでブラックボックスであった予測の根拠（投稿頻度、画像の輝度、テキスト長などの貢献度）を可視化することに成功しました。
