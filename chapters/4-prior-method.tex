...
なお，原論文ではGRUとLSTMの比較も行われ，性能差が大きくないことを報告している \cite{Kim2023InfluencerRank}。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/edge_mask.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/node_mask.png}
