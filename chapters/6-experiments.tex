...
図\ref{fig:feature-importance-jan}〜図\ref{fig:edge-importance-mar}に，1月，3月それぞれに対する重要度（importance）の可視化結果を示す．

\begin{figure}[htbp]
\centering
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/importance/top20-feat-pos0.png}
    \caption{特徴量の削除によるスコア変化（１月）}
    \label{fig:feature-importance-jan}
\end{minipage}
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/importance/top20-edge-pos0.png}
    \caption{特徴量の追加によるスコア変化（１月）}
    \label{fig:edge-importance-jan}
\end{minipage}
\end{figure}
...
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/importance/top20-feat-pos2.png}
    \caption{特徴量の削除によるスコア変化（３月）}
    \label{fig:feature-importance-mar}
\end{minipage}
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/importance/top20-edge-pos2.png}
    \caption{特徴量の追加によるスコア変化（３月）}
    \label{fig:edge-importance-mar}
\end{minipage}
\end{figure}
...
マスクの値とスコアへの影響度をDeletion/Inclusionプロットを作成することでさらに分析する。
\begin{figure}[htbp]
\centering
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/di/d-feature-pos2.png}
    \caption{特徴量の削除によるスコア変化（３月）}
    \label{fig:feature-deletion-mar}
\end{minipage}
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/di/i-feature-pos2.png}
    \caption{特徴量の追加によるスコア変化（３月）}
    \label{fig:feature-inclusion-mar}
\end{minipage}
\end{figure}
...
\begin{table}[htbp]
  \centering
  \caption{最も重要度が高いエッジに関連する投稿（Hashtag）}
  \begin{tabular}{lllll}
    \toprule
...
\begin{table}[htbp]
  \centering
  \caption{重要度上位エッジに関連する投稿（Mention）}
...
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/di/d-edge-pos2.png}
    \caption{エッジの削除によるスコア変化（３月）}
    \label{fig:edge-deletion-mar}
\end{minipage}
\begin{minipage}[b]{0.49\columnwidth}
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/di/i-edge-pos2.png}
    \caption{エッジの追加によるスコア変化（３月）}
    \label{fig:edge-inclusion-mar}
\end{minipage}
\end{figure}
