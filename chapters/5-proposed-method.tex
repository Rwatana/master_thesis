...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/mask_optimization.png}
    \caption{MaskOpt の概念図（予測を維持しつつ特徴量・エッジを疎に残すマスクを最適化する）}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/gcn_concat.png}
