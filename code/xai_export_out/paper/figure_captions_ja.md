...
- 静的特徴（followers/followees/posts*history + cat*/type\_）と動的特徴（投稿・コメント・間隔など）で,総寄与の比率を比較。『過去プロフィールが強い』などの考察に対応。
