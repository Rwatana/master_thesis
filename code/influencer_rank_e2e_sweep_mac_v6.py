...
def prepare_graph_data(
    ...
    if metric_denominator == "followers":
        print("Denominator followers are taken from influencers.txt (profile followers).")
...
def main():
    ...
    # Target (engagement score) definition
    parser.add_argument(
        "--metric_numerator",
        type=str,
        default="likes",
        choices=["likes", "likes_and_comments"],
        help="Numerator for engagement score. 'likes_and_comments' uses likes+comments.",
    )
    parser.add_argument(
        "--metric_denominator",
        type=str,
        default="followers",
        choices=["posts", "followers"],
        help="Denominator for engagement score. 'followers' uses follower counts from influencers.txt.",
    )
